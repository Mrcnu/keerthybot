...
# Bot information
API_ID = environ.get('API_ID', '27788053')
if len(API_ID) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '6088575087 1150808463')
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002393248227').split()]
if len(INDEX_CHANNELS) == 0:
    print('Info - INDEX_CHANNELS is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '1002411569458')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002262310384')
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://Artrlc:Artrlc@artrlc.pikz3gw.mongodb.net/?retryWrites=true&w=majority")
if len(DATABASE_URL) == 0:
    print('Error - DATABASE_URL is missing, exiting now')
    exit()
DATABASE_NAME = environ.get('DATABASE_NAME', "venom2")
...
SHORTLINK_API = environ.get("SHORTLINK_API", "97229868b1864ea8a4a3e0c5fca7addb005f20c2")
